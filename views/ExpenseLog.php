...
<div>
    ...
    <div id="fullViewLarge-1" class="md:hidden  xl:hidden  lg:block max-w-4xl mx-auto bg-[#03352c]  shadow-lg rounded-lg p-5 mt-5 cursor-pointer sm:hidden">
...
<script>
        ...
        function toggleSmallView(expenseId) {
            ...
            simplifiedView.classList.add('hidden');   // pag kin-lick hide simplified view 
            fullView.classList.remove('hidden');     // show fullview
        }


        // sa large view naman to --


        // so far dikopa nasosolve etong sa fullview para sa large devices, lumilitaw kase 
        // sa small view yung output nya
        ...
        function toggleLargeView(expenseId) {
            ...
            largeSimplifiedView.classList.add('hidden');    // pag kin-lick hide simplified view 
            fullViewLarge.classList.remove('hidden');      // show fullview
        }
        ...
        function saveChanges(expenseId) {
            ...
            const inputs = fullView.querySelectorAll('input');
                                            ...
                                            // yung mga inputs dito don sa querySelector 
                                            // kukunin nya lahat ng existing inputs
                                            // and a itemize nya as arrays.
                                            // kaya kung mapapansin nyo yung naka indicate yung mga indexes nila dito

            const updatedData = {           // object to and  value holder ung sa loob 
                update_id: expenseId,       // parang php variable sa loob net dependent data type nya depende sa value na 
                user_id: inputs[1].value,   // ho-hold nya
            ...
            const expTime = updatedData.ExpenseTime; 
            const expType = updatedData.ExpenseType;
...
// para sa larger resolution device tong sa baba
    ...
    function saveChangesLarge(expenseId) {
            ...
            // not working pato. supposedy ihahide nito yung fullview ka click nung save changes.
    ...
    function deleteExpense(id) {
        if (confirm("Are you sure you want to delete this expense?")) {
            ...
            if (largeSimplifiedView) {
                largeSimplifiedView.remove();
            }
            if (fullViewLarge) {
                fullViewLarge.remove();
            }

...
<main class="grid min-h-full place-items-center bgGreen px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center py-6 px-8 sm:py-10 sm:px-16 tlGreen rounded-xl">
        ...
        <div class="mt-6 sm:mt-10 flex items-center justify-center gap-x-6">
            <a href="/dashboard" class="btGreen rounded-3xl px-3.5 py-2.5 text-xs sm:text-lg font-semibold textGray hover:bg-emerald-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Go back home</a>

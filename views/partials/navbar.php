<nav class="fixed tlGreen w-full z-50 border-b border-one shadow-lg border-gray-800">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href='/expenselog'
                            ...
                            Log</a>
                        <a href='/statistics'
                            class="<?= isUri('/statistics') ? 'btGreen' : '' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:text-green-300">Statistics</a>
                        <a href='/shared'
                            class="<?= isUri('/shared') ? 'btGreen' : '' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:text-green-300">Shared
                            Expense</a>
                    </div>
                </div>
            </div>

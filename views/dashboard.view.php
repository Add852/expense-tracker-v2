...
<main class='test h-screen bgGreen'>
    ...
    <div class='bgGreen pt-4 overflow-y-scroll grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 px-5 sm:px-10 md:px-16 lg:px-20 xl:px-24 xl:px-30'>

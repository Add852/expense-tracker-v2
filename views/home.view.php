...
<div class="bg-[#03352c] text-gray-300">
  <div class="xl:container mx-auto text-center relative ">
    <section>
      ...
      <button class="cursor-pointer p-5 transition-transform rounded-full text-gray-300 uppercase text-xl font-semibold hover:scale-110 bg-[#1a664d] hover:bg-[#165440]"><a href="/login"></a>
        Get Started
      </button>
    </section>
    <br><br><br><br><br>

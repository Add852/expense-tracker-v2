...
<div class="container mx-auto p-2.5" id="page">
    <div class="container p-2.5" id="content">
                <section class="text-center">
                    ...
                    <div class="text-xl">
                        <h1 class="text-gray-300 p-5">Lorem ipsum dolor sit amet</h1>
                    </div>
                    <div>
                        <button class="cursor-pointer p-5 transition-transform rounded-full text-gray-300 uppercase text-xl font-semibold hover:scale-110" style="background-color: #1a664d;">Lorem ipsum dolor sit amet</button>
                    </div>
                </section>
                <section>

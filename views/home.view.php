...
<div class="bg-[#03352c] text-gray-300">
  <div class="xl:container mx-auto text-center relative">
    ...
    <section class="-space-y-10">
      <div class="mx-20 bg-[#d5ffdf] h-72">
        <div>
        <!-- insert svg here -->
        </div>
        <div class="m-10">
      ...
      <div class="mx-20 bg-[#1a664d] h-72 flex">
        <div class="pl-64 py-10">
        <img width="250px" height="250px" src="https://goodbudget.com/wp-content/uploads/2019/06/10155313/whatyouget-sync-and-share-couple-1024x857.png" >
        </div>
        <div class="m-10">
          <div>
